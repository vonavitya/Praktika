...
namespace _1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("Программа вычисляет кратчайшее расстояние от текущей позиции до начлала координат на");
                Console.WriteLine("поле игру в Гексгон. В файле \"INPUT.TXT\" должна находиться информация о ходах, кот");
                Console.WriteLine("орые привели игрока в текущую позицию. В первой строке - количество ходов. Далее - в");
                Console.WriteLine("каждой строке ось по которой идет перемещение (X/Y/Z) и через пробел количество клет");
                Console.WriteLine("ок на которое пользователь перемешается (со знаком минус если направление обратно на");
                Console.WriteLine("правлению выбранной оси. Результат вы найдете в файле \"OUTPUT.TXT\"\n");
                Actions();
