...
namespace _2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("Программа выдаёт лексикографически минимальную строку, которая получается в результате");
                Console.WriteLine("в результате сдвига символов в пределах исходной строки не более чем на K позиций. Дан");
                Console.WriteLine("ные программа берёт из файла \"INPUT.TXT\". В первой строки д.б. указано K. В последую");
                Console.WriteLine("щей - строка с символами (маленькими буквами англ. алфавита. Результирующая строка буд");
                Console.WriteLine("ет помещена в файл \"OUTPUT.TXT\".\n");
                Actions();
